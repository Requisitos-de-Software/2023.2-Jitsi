...
Tem como objetivo mostrar em ordem como as terefas serão desenvolvidas ao longo do semestre, com as repectivas datas de conclusão, ajudando na organização e acompanhamento do progresso das atividades.
...
<font size="3"><p style="text-align: center">Tabela 1: Apresentação do Projeto <br/> Fonte: Autores.</p></font>
...
<font size="3"><p style="text-align: center">Tabela 2: Elicitação - Técnicas e Priorização <br/> Fonte: Autores.</p></font>
...
<font size="3"><p style="text-align: center">Tabela 3: Modelagem de Requisitos <br/> Fonte: Autores.</p></font>
...
<font size="3"><p style="text-align: center">Tabela 4: Modelagem de Requisitos Ágio <br/> Fonte: Autores.</p></font>
...
<font size="3"><p style="text-align: center">Tabela 5: Análise de Requisitos 1 <br/> Fonte: Autores.</p></font>
...
| Atividade                         | Período de Desenvolvimento   | Responsáveis | Revisor |
|-----------------------------------|------------------------------|--------------|---------|
| Pós Rastreabilidade - Gerência II | Início: 14/11 <br>Fim: 16/11 | Todos        | Todos   |
| Gravação do vídeo de apresentação | Início: 18/11 <br>Fim: 19/11 | Todos        | Todos   |

<font size="3"><p style="text-align: center">Tabela 6: Pós-Rastreabilidade. <br/> Fonte: Autores.</p></font>
...
<font size="3"><p style="text-align: center">Tabela 7: Análise de Requisitos 1.2 <br/> Fonte: Autores.</p></font>
...
| Atividade                         | Período de Desenvolvimento   | Responsáveis | Revisor |
|-----------------------------------|------------------------------|--------------|---------|
| Desenvolvimento do Projeto Final  | Início: 29/11 <br>Fim: 02/12 | Todos        | Todos   |
| Gravação do vídeo de apresentação | Início: 04/11 <br>Fim: 05/12 | Todos        | Todos   |

<font size="3"><p style="text-align: center">Tabela 8: Entrega Final <br/> Fonte: Autores.</p></font>
...
| `1.2`  | 20/09/2023 | Padronização do documento                              | [Bruno](https://github.com/BrunoHenrique00) e [Catlen](https://github.com/catlenc) | [Pedro](https://github.com/PedroSiq) |
