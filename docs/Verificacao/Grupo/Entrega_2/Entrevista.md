...
| 7   | A comunicação durante a elicitação é clara e eficaz? |       |      |
...
| 11  | Todos os requisitos estão documentados? |  |  |      
| 12  | As informações obtidas são registradas de forma precisa e completa? |  |  |   
| 13  | São consideradas questões éticas na aplicação da técnica?| | |     
| 14  | A linguagem usada é compreensível para todos os stakeholders? | | |
| 15  | Os requisitos são testáveis? Podem ser verificados para garantir que foram atendidos? |  |  |                                                                                    
