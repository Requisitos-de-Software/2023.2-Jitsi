...
## **Introdução**
<p align="justify">
&emsp;&emsp;Este artefato apresenta a técnica de priorização conhecida como <b>Three Level Scale (TLS)</b>. O TLS é uma técnica que divide os requisitos em <b>três níveis de prioridade: alta, média e baixa.</b></p>

<p align="justify">
&emsp;&emsp;Na técnica TLS, os principais critérios são <b>"importância"</b> e <b>"urgência"</b>, que determinam em qual dos três quadrantes o requisito se encaixa. De acordo com Karl E. Wiegers, os quadrantes são definidos da seguinte forma:</p>
