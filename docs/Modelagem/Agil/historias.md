...
## **Metodologia**
<p align="justify">
&emsp;&emsp; Para a criação das histórias de usuário, estabelecemos um modelo padrão, detalhado na Tabela 1. A validação das Histórias de Usuário foi realizada por meio de um processo de verificação com a participação de uma usuária do aplicativo Jitsi. A entrevista foi conduzida via Teams no dia 30 de outubro de 2023, às 21:30.
</p>
...
## **Histórias de usuário**
<p align="justify">
&emsp;&emsp; As tabelas a seguir apresentam as histórias de usuário que foram elaboradas com base nos requisitos funcionais classificados como 'Requisitos de Alta Prioridade' na priorização utilizando a técnica Three level-scale.
</p>
